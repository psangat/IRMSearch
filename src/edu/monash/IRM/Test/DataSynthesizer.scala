        ...
        if (patternMatcher.find()) {
          ...
          breakable {
            while (br.hasNextLine()) {
              ...
              recordsList.add("{\"iSegment\":%s,\"SomatTime\":%s,\"kmh\":%s,\"CarOrient\":%s,\"EorL\":%s,\"minSND\":%s,\"maxSND\":%s,\"Rock\":%s,\"Bounce\":%s,\"minCFA\":%s,\"maxCFA\":%s,\"accR3\":%s,\"accR4\":%s,\"Direction\":\"%s\",\"minCFB\":%s,\"maxCFB\":%s,\"LATACC\":%s,\"maxBounce\":%s,\"PipeA\":%s,\"PipeB\":%s,\"GPSLat\":%s,\"GPSLon\":%s}"
